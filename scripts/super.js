...
const resume = [
  ...
  '<br>',
  '<h2>SKILLS:</h2>',
  '<p>HTML5: Semantics are important for accessibility and SEO. I deliver clean, concise markup that is accessible to its users.</p>',
  '<p>CSS: Modern development with SCSS, CSS Flexbox, Bootstrap, can drive a design from start to finish faster than before. Implementing these technologies while keeping the code minimalist and clean is how I roll.</p>',
  '<p>JavaScript: The web language that started it all with me. ES6 with Babel, React, Vue, and even Typescript are some of the technologies I utilize daily. Programming paradigms such as functional and OOP have kept my code clean and consistent. While this may seem contradictive, knowing such paradigms keeps me flexible as a developer.</p>',
  '<p>PHP: PHP has been the main back-end language I have been utilizing. From simple page layouts, to full MVC structured programs, on the fly report generating systems, and AJAX driven blog pages, growth in the back-end has led me to be a well-rounded full stack developer.</p>',
  '<p>C#, Python, GraphQL, SQL, Shell: Learning never stops. I have been learning C# and Python, as well as have working knowledge traditional SQL statements and an ever-growing interest in GraphQL. Further I know my way around bash and cmd. I love growth and believe that learning and array of technologies and concepts contribute to this growth.</p>',
  '<p>Git: This technology, while so simple, is so powerful. Another technology I adore and use daily.</p>',
  ...
  '<p>Examples of work: <a href="abouthealth.com" target="_blank">abouthealth.com</a>, <a href="sadoff.com" target="_blank">sadoff.com</a>, <a href="1855beef.com" target="_blank">1855beef.com</a>, <a href="unisoncu.org" target="_blank">unisoncu.org</a>, <a href="faithtechnologies/careers/" target="_blank">faithtechnologies.com/careers</a>, <a href="dbsbenefits.com" target="_blank">dbsbenefits.com</a></p>',
  '<br>',
  '<h2>Stellar Blue Technologies</h2>',
  '<p><small>September 15 – May 16</small></p>',
  '<p>Front-End Web Development With WordPress</p>',
  '<p>Examples of work: <a href="riverviewgardens.org" target="_blank">riverviewgardens.org</a>, <a href="castlepierce.com" target="_blank">castlepierce.com</a>, <a href="gbbg.orgm" target="_blank">gbbg.org</a>, <a href="crytycal.com" target="_blank">crytycal.com</a>, <a href="ati-ae.com" target="_blank">ati-ae.com</a>',
  '<br>',
  '<h2>WebFitters</h2>',
