...
const resume = [
  ...
  '<br>',
  '<h2>SKILLS:</h2>',
  '<p><strong>Languages:</strong> HTML5, CSS/SCSS, JavaScript(ES5 - ES6)/jQuery/ReactJS, PHP, C#, SQL, Shell</p>',
  ...
  '<p><strong>Extras:</strong> Adobe CC (Photoshop, Illustrator), Agile Development, Office Suite (Google, Microsoft). Currently working toward MCSA for C#/ASP.NET development.</p>',
  '<br>',
  '<br>',
  '<h2>EXPERIENCE:</h2>',
